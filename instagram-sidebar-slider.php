...
Plugin Name: InstaG Sidebar Slider

Plugin URI: http://geniusextensions.com/wpdemo/

Description: Thank you for installing InstaG Sidebar Slider. It helps to display instagram post on your website sidebar.
...
class RealInstragramSlider{
    ...
    public static function add_real_instagram_tools_options_page(){
        ...
        add_options_page('Instagram Sidebar Slider', 'Instagram Sidebar Slider', 'administrator', __FILE__, array('RealInstragramSlider','sw_instagram_tools_options'));
...
<?php
    ...
    public function real_instagram_register_settings_and_fields(){
        ...
        add_settings_field('pageURL', 'Instagram Post URL', array($this,'pageURL_settings'), __FILE__,'real_instagram_main_section');
...
$print_instagram .= '<iframe src="'.$pageURL.'/embed/?v=7&w='.$horizontal.'&h='.$vertical.'&b=no&bg=#000&p=3" allowtransparency="true" frameborder="0"

 scrolling="no" style="border:none;overflow:hidden; width:'.$width.'px; height:'.$height.'px" ></iframe>';


$imgURL = plugin_dir_url(__FILE__).'assets/instagram-icon.png';
